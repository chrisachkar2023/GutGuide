...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-moss-700 text-white hover:bg-moss-800 active:bg-moss-900 disabled:bg-moss-300",
  secondary:
    "bg-[#f9f5ef] text-ink ring-1 ring-inset ring-black/10 hover:bg-cream-100 active:bg-cream-200",
...
const BASE =
  ...
  "disabled:cursor-not-allowed disabled:opacity-60 active:scale-[0.99] whitespace-nowrap";
